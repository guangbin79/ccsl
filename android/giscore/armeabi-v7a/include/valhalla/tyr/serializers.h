...
std::string serializeDirections_wayid(Api& request, const std::vector<std::vector<std::vector<uint64_t>>>& routes_legs_wayids,
                            const std::vector<route_break_data_t>& break_datas);
